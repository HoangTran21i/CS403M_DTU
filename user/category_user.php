...
$sql_product = "SELECT product_id,product_img, product_name, product_price_new FROM tbl_product $where_clause $order_clause LIMIT $products_per_page OFFSET $offset";
